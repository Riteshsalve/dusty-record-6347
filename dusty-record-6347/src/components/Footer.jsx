...
const Footer = () => {
  return (
    <Box width="92%" margin={'auto'} marginTop={4} background={'#5A79F5'} color={'white'} p="40px" textAlign={{base:"center",sm : "center" , md:"start",lg:"start",xl:"start","2xl":"start"}} borderRadius={10} >
      <Flex justifyContent={"space-around"}  direction={ {base : "column", sm : "column" , md:"column" , lg : "row" , xl:"row" , "2xl" : "row"}} gap="20px" mt="5px">
        <Grid templateColumns={{base : 'repeat(1,1fr)' , sm : 'repeat(1,1fr)' , md:'repeat(2,1fr)',lg:'repeat(2,1fr)',xl:'repeat(4,1fr)',"2xl":'repeat(4,1fr)'}} gap="5px">
          ...
          <Box  mt="10px" >
            ...
            <Text>
              RS Dignostic Centre Limited New
              <br/>
               Bus Stand, 
              Main Village, 
               Near Post Office, Ichhapur ,
               Burhanpur 450441
            </Text>
            <Text cursor={"pointer"} >Email: RSDigno@caregmail.com</Text>
          </Box>
        </Grid>
        <Box>
            <Heading>Talk to US</Heading>
            <Text>Know More about RS DignoCentre</Text>
            ...
            <Box>
            <Button color={"#222566"} mt="10px">Connect With RS Diagno</Button>
            </Box>
             <Box >
              <Text fontSize="10px" mr="100px" mt="40px">&copy; RS Digno 2023</Text>
