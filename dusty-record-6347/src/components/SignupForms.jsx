...
export default function SignupsForms() {
  ...
  const fetchPostData = (userData) => {
     const userDetail= axios.post(`https://elated-gold-bandicoot.cyclic.app/signup`,userData)
  ...
  const handleSubmit = (e) => {
    ...
    //  }
      ...
      let res = false;
       const data =  axios.get(`https://elated-gold-bandicoot.cyclic.app/signup`).then((res) => res.data)
       if(data.length > 0){
            data.forEach(el=>{
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <Stack spacing={8} mx={'auto'} maxW={{base:"md" , sm : "md" , md :"lg" , lg:"xl" , xl : "xl" , "2xl" :"lg"}} py={12} px={6}>
            <Stack align={'center'}>
              <Heading fontSize={'4xl'} color={"#5A79F5"} textAlign={'center'}>
                Sign up
              </Heading>
            </Stack>
            <Box
